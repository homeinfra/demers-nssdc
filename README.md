...
This is a Secondary Domain Controller (NSSDC) running on Zentyal.
...
```bash
wget -qO- 'https://raw.githubusercontent.com/jeremfg/setup/refs/heads/develop/src/setup_git' | bash -s -- git@github.com:homeinfra/demers-nssdc.git main -- ./src/setup
```
